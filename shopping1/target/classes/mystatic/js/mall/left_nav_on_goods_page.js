...
$(function () {
 ...
 //  <a th:href="@{selectById.do/(id=${o.id})}"><img src="/img/home/feature_prodects/cont2.jpg" th:src="${o.image}" th:title="${o.name}" class="show_img"/></a> selectById.do?id
                        for (var i = 0; i < data.length; i++) {
                            $all_product.append(
                                ...
                                "<a href='selectById.do?id="+data[i].id+"'> " +
