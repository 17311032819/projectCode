...
public class GoodsController {
    ...
    public String publish(HttpServletRequest request, Model model,ShopInformation shopInformation) {
        if (shopInformation.getName()!=null){
            System.out.println(shopInformation.getDisplay());
            System.out.println(shopInformation.getName());
    ...
    public String selectById(@RequestParam int id,
        ...
        try {
            ...
            System.out.println("id="+shopInformation.getImage());
//            shopInformation.setImage(StringUtils.getInstance().getFilePath(shopInformation.getImage()));
