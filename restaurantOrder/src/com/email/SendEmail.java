...
public class SendEmail {
    ...
    private final String myEmailAccount = "2726093553@qq.com";//发送的邮箱
    private final String myEmailPassword = "spsbvfvjcsjwdhaj";
    ...
    public  MimeMessage createMessage(Session session, String sendMail, String receiveMail,String info) throws Exception {
        ...
        message.setRecipient(MimeMessage.RecipientType.TO, new InternetAddress(receiveMail, "2726093553", "UTF-8"));
